...
<div  style="background-color:#FAFAEF;width:961px;text-align:left;height:80px" >
...
<div  style="background-color:#FAFAEF;width:961px;text-align:left;height:75px" >
        ...
        <div id="AgencyDiv">
			...
			<div>
                <%= Html.DropDownList("SelectedAgency", (SelectList)ViewData["AgencyList"], new { @class = "SelectedAgency"})%>
                <div id="Div5"></div>
			</div>
        </div>
        ...
        <tr >
            ...
            <th>
                <% if (SortBy == "UnitName" && Order == "Asc")
                   { %>
                <%= Html.ActionLink(sUnitName, "Trends", new { SortBy = "UnitName", Order = "Dis", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency, SelectedUnit = sUnit })%><img id="Img4" runat="server" alt="Sort Descending" src="~/images/downarrow.gif" />
                <% }
                   else
                   { %>
                <%= Html.ActionLink(sUnitName, "Trends", new { SortBy = "UnitName", Order = "Asc", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency, SelectedUnit = sUnit })%>
                    <%if (SortBy == "UnitName")
                      {%>
            ...
            <th class="dataright">
                <% if (SortBy == "VolumeOfFeedback" && Order == "Asc")
                   { %>
                <%= Html.ActionLink("Total Volume of Feedback", "Trends", new { SortBy = "VolumeOfFeedback", Order = "Dis", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency, SelectedUnit = sUnit })%><img id="Img2" runat="server" alt="Sort Descending" src="~/images/downarrow.gif" />
                <% }
                   else
                   { %>
                <%= Html.ActionLink("Total Volume of Feedback", "Trends", new { SortBy = "VolumeOfFeedback", Order = "Asc", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency, SelectedUnit = sUnit })%>
            ...
            <th class="dataright">
                <% if (SortBy == "NumOfPosComments" && Order == "Asc")
                   { %>
                <%= Html.ActionLink("Volume of Positive Feedback", "Trends", new { SortBy = "NumOfPosComments", Order = "Dis", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency, SelectedUnit = sUnit })%><img id="Img9" runat="server" alt="Sort Descending" src="~/images/downarrow.gif" />
                <% }
                   else
                   { %>
                <%= Html.ActionLink("Volume of Positive Feedback", "Trends", new { SortBy = "NumOfPosComments", Order = "Asc", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency, SelectedUnit = sUnit })%>
            ...
            <th class="dataright">
                <% if (SortBy == "NumOfNegComments" && Order == "Asc")
                   { %>
                <%= Html.ActionLink("Volume of Negative Feedback", "Trends", new { SortBy = "NumOfNegComments", Order = "Dis", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency, SelectedUnit = sUnit })%><img id="Img11" runat="server" alt="Sort Descending" src="~/images/downarrow.gif" />
                <% }
                   else
                   { %>
                <%= Html.ActionLink("Volume of Negative Feedback", "Trends", new { SortBy = "NumOfNegComments", Order = "Asc", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency, SelectedUnit = sUnit })%>
    ...
    <% 
       ...
       foreach (var item in Model)
       {
        ...
        <tr style="<%=col%>">
            ...
            <td class="dataright">
                <%= string.Format("{0,0}", Convert.ToDecimal(Html.Encode(item.VolumeFeedBack)))%>
            </td>
            <td class="dataright">
                <%=string.Format("{0,0}", Convert.ToDecimal(Html.Encode(item.NumOfPosComments)))%>
            </td>
             <td class="dataright">
                <%= string.Format("{0,0}", Convert.ToDecimal(Html.Encode(item.NumOfNegComments)))%>
            </td>
        </tr>
    <% } %>
