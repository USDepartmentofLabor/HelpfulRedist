  ...
  <% using (Html.BeginForm())
     {
        ...
        %>
<h1>Rate This Page Feedback Results: Search</h1>

<div  style="background-color:#FAFAEF;width:961px;text-align:left;height:100%" >
<%string ErrorMessage = Html.ValidationMessage("FromDateValidation").ToString();%>
    <%if (ErrorMessage.Contains("Invalid Date Range"))
      { %><span class="errorMessage1"><%=ErrorMessage%></span><br /><br />
    <%}
      else
      {
...
<div  style="background-color:#FAFAEF;width:961px;text-align:left;height:75px" >
		...
		<div id="FromDateDiv">
    		<div>
            <label class="labelFeedback" for="txtDateFrom">From:</label>
            </div>
        ...
        <div id="ToDateDiv">
			<div>
                <label class="labelFeedback" for="txtDateTo">To:</label> 
             </div>
			<div>
...
<div  style="background-color:#FAFAEF;width:961px;text-align:left;height:75px" >
        <div id="URLContainsDiv">
			<div><label class="SelectionPanelHeader" for="txtURLContains">URL Contains:</label></div>
				<input type="text" id="txtURLContains" value="<%=Html.Encode(uContains)%>" name="txtURLContains" class="DateFromText"  onkeypress="return NoSubmission()" 
        ...
        <tr >
            ...
            <th>
                <% if (SortBy == "URLLink" && Order == "Asc")
                   { %>
                <%= Html.ActionLink("URL", "Search", new { SortBy = "URLLink", Order = "Dis", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency })%><img id="Img4" runat="server" alt="Sort Descending" src="~/images/downarrow.gif" />
                <% }
                   else
                   { %>
                <%= Html.ActionLink("URL", "Search", new { SortBy = "URLLink", Order = "Asc", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency })%>
                    <%if (SortBy == "URLLink")
                      {%>
            ...
            <th>
                <% if (SortBy == "AgencyName" && Order == "Asc")
                   { %>
                <%= Html.ActionLink("Agency", "Search", new { SortBy = "AgencyName", Order = "Dis", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency })%><img id="Img7" runat="server" alt="Sort Descending" src="~/images/downarrow.gif" />
                <% }
                   else
                   { %>
                <%= Html.ActionLink("Agency", "Search", new { SortBy = "AgencyName", Order = "Asc", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency })%>
            ...
            <th>
                <% if (SortBy == "VolumeOfFeedback" && Order == "Asc")
                   { %>
                <%= Html.ActionLink("Volume of Feedback", "Search", new { SortBy = "VolumeOfFeedback", Order = "Dis", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency })%><img id="Img2" runat="server" alt="Sort Descending" src="~/images/downarrow.gif" />
                <% }
                   else
                   { %>
                <%= Html.ActionLink("Volume of Feedback", "Search", new { SortBy = "VolumeOfFeedback", Order = "Asc", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency })%>
            ...
            <th>
                <% if (SortBy == "PositiveFeedback" && Order == "Asc")
                   { %>
                <%= Html.ActionLink("% of Positive Feedback", "Search", new { SortBy = "PositiveFeedback", Order = "Dis", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency })%><img id="Img5" runat="server" alt="Sort Descending" src="~/images/downarrow.gif" />
                <% }
                   else
                   { %>
                <%= Html.ActionLink("% of Positive Feedback", "Search", new { SortBy = "PositiveFeedback", Order = "Asc", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency })%>
            ...
            <th>
                <% if (SortBy == "NumOfPosComments" && Order == "Asc")
                   { %>
                <%= Html.ActionLink("No. of Positive Feedbac Comments", "Search", new { SortBy = "NumOfPosComments", Order = "Dis", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency })%><img id="Img9" runat="server" alt="Sort Descending" src="~/images/downarrow.gif" />
                <% }
                   else
                   { %>
                <%= Html.ActionLink("No. of Positive Feedback Comments", "Search", new { SortBy = "NumOfPosComments", Order = "Asc", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency })%>
            ...
            <th>
                <% if (SortBy == "NumOfNegComments" && Order == "Asc")
                   { %>
                <%= Html.ActionLink("No. of Negative Feedback Comments", "Search", new { SortBy = "NumOfNegComments", Order = "Dis", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency })%><img id="Img11" runat="server" alt="Sort Descending" src="~/images/downarrow.gif" />
                <% }
                   else
                   { %>
                <%= Html.ActionLink("No. of Negative Feedback Comments", "Search", new { SortBy = "NumOfNegComments", Order = "Asc", txtDateFrom = tDateFrom, txtDateTo = tDateTo, txtURLcontains = uContains, SelectedAgency = sAgency })%>
